...
def login_user(request):
    if request.method == "POST":
        ...
        if user is not None:
            ...
            messages.success(request, ('Такого користувача не існує.'))
...
def add_driver(request, trip_id):
    if request.user.is_authenticated:
        ...
        messages.success(
            request, ('Ви повині увійти, щоб додати водія'))
        return redirect('login')
    ...
    if request.user.is_authenticated:
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                trip.save()
                messages.success(
                    request, ('Пасажир успішно доданий.'))
        ...
        messages.success(
            request, ('Ви повині увійти, щоб додати пасажира'))
        return redirect('login')
